...
def main():
    ...
    Rd2 = np.array([[-0.8, -0.1047, -0.6531], [-0.433, 0.8241, 0.3652], [0.8, 0.5567, -0.6634]])
    Pd2 = np.array([[0.2158], [0.1228],	[0.1664]])

    Rd3 = np.array([[-0.8, -0.1447, -0.6531], [-0.439, 0.8241, 0.3652], [0.5, 0.5567, -0.6634]])
    Pd3 = np.array([[0.2048], [0.1088],	[0.1564]])
    
    Rd4 = np.array([[-0.8314, -0.1647, -0.6531], [-0.439, 0.8241, 0.5652], [0.1, 0.5567, -0.6734]])
    Pd4 = np.array([[0.1548], [0.1588],	[0.1764]])
    
    Rd5 = np.array([[-0.8334, -0.1847, -0.6631], [-0.4493, 0.8341, 0.5752], [0.1314, 0.5967, -0.6774]])
    Pd5 = np.array([[0.2548], [0.1588], [0.1766]])
